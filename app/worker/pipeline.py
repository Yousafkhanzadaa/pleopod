...
from app.agents.research_review import ResearchReviewAgent
...
STEP_TO_QUEUE: dict[PipelineStep, str] = {
    ...
    PipelineStep.RESEARCH_REVIEW: "research_review_queue",
...
AGENTS: dict[PipelineStep, PipelineAgent] = {
    ...
    PipelineStep.RESEARCH_REVIEW: ResearchReviewAgent(),
